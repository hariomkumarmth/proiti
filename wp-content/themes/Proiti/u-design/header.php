...
<script  type="text/javascript" src="<?php bloginfo('template_url'); ?>/scripts/vAccord.js" type="text/javascript"></script>
<script  type="text/javascript" src="<?php bloginfo('template_url'); ?>/scripts/html5.js" type="text/javascript"></script>
<script  type="text/javascript" src="<?php bloginfo('template_url'); ?>/scripts/fader.js" type="text/javascript"></script>
<script  type="text/javascript" src="<?php bloginfo('template_url'); ?>/scripts/newsSlider.js" type="text/javascript"></script>
<script  type="text/javascript" src="<?php bloginfo('template_url'); ?>/scripts/popCalendar.js" type="text/javascript"></script>
<script  type="text/javascript" src="<?php bloginfo('template_url'); ?>/scripts/popup.js" type="text/javascript"></script>
<script  type="text/javascript" src="<?php bloginfo('template_url'); ?>/scripts/sidebar.js" type="text/javascript"></script>
<script  type="text/javascript" src="<?php bloginfo('template_url'); ?>/scripts/validate.js"></script>
<script  type="text/javascript" src="<?php bloginfo('template_url'); ?>/scripts/testValidate.js"></script>
                                ...
                                <div class="cont_col_1 widget_text substitute_widget_class">
                                    <div class="textwidget">
                                        <div class="two_third">
                                            ...
                                            <?php  $args='category_name=before home';
                                                query_posts( $args );
                                               while ( have_posts() ) : the_post();
                                                    echo '<h2 style="color:#333;margin-top:0;font-size:32px !important;">';
                                                        the_title();
                                                    echo '</h2>';                             
                                                    the_content();                             
                                               endwhile;
                                        ...
                                        <div class="one_third last_column">
                                            <div style="margin-top:20px; color:#000; text-align:right; font-size:20px; font-style:italic;">
                                            <?php  $args='category_name=before home right';
                                                    query_posts( $args );
                                                    while ( have_posts() ) : the_post();                                               
                                                        the_content();               
                                            ?>              
